// HomeworkTester
// tester program for homework.cpp
...
int main()
{
	...
	enqueue(&a1, q);
	Assignment a2 = {"ECE 150", 6, 12, 4, "struct"};
	enqueue(&a2, q);
	Assignment a3 = {"ECE 100", 3, 8, 5, "final report"};
	enqueue(&a3, q);
	Assignment a4 = {"Math 117", 9, 5, 30, "partial fraction"};
	enqueue(&a4, q);
